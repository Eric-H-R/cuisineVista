...
const CardEstadisticas = ({ cardsData }) => {
  return (
    <Box mt={4} sx={{ display: 'flex', gap: 2, justifyContent: 'space-around', width: '100%', mb:4 }}>
      ...
      {cardsData.map((card, index) => {
        ...
        return (
          ...
          <Card key={index} elevation={0}   sx={{ borderRadius: 4, width: '35%', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)',  background: 'linear-gradient(to bottom, #ce8c4e10 0%, #ede0d436 100%)'}} >
